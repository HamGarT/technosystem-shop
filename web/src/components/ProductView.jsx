            ...
            <div className="flex items-center space-x-4 mb-6">
              <div className="flex items-center bg-gray-100 border border-gray-500 rounded-md">
                <button
                  ...
                  disabled={quantity <= 1}
                  className={`p-3 rounded-l-md ${quantity <= 1
                ...
                <button
                  ...
                  className={`p-3 rounded-r-md ${quantity >= product.stock
                    ? 'text-gray-400 cursor-not-allowed'
                    : 'text-gray-600 hover:bg-gray-300'
                    }`}
                >
              ...
              <button
                ...
                className={`flex-grow font-semibold py-3 px-6 rounded-md transition-colors flex items-center justify-center space-x-2 ${product.stock > 0
